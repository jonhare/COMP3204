...
Due date: Friday 14th December, 16:00.  
Development data download: [training.zip](./training.zip)    
Testing data download: [testing.zip](./testing.zip)  
Handin: [1819/COMP6223/3/](https://handin.ecs.soton.ac.uk/handin/1819/COMP6223/3/)   
...
* A plain text file listing the user ids (e.g. xx1g18) of the members of your team; one per line.
